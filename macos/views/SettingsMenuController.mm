...
-(void)viewDidLoad
{
    ...
    (void)[self initDelegateWithTable:_table];
...
#else
#warning This version of macOS SDK does not support the detection of thumbstick buttons. You will not be able to rebind them from the menu on 10.14.1 or higher
#endif
...
#else
#warning This version of macOS SDK does not support the detection of Start and Back buttons. You will not be able to rebind them from the menu on 10.15 or higher.
#endif
...
#else
#warning This version of macOS SDK does not support the detection of the Guide button. You will not be able to rebind it from the menu on 11.0 or higher.
#endif
...
-(void)checkController
{
    ...
    if (gamepad.extendedGamepad == nil || gamepad.extendedGamepad.valueChangedHandler != nil)
        return;
